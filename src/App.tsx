...
function App() {
  ...
  const onDevelopment: boolean = true;
        ...
        <>
          ...
          <FullScreenSection id="1">
            ...
            <p className="text-center text-[#a0a3a8]">
              I am a passionate and dedicated frontend developer creating
              visually stunning and responsive websites and web apps.
          ...
          <FullScreenSection id="2">
            ...
            <p>
              ...
              Veritatis iure porro fugiat distinctio deserunt ea! Doloribus
              dolorem voluptates saepe fugiat aliquid?
            </p>
          </FullScreenSection>
